...
router.get(
  ...
  controller.trackByOrderId.bind(controller)
);
...
router.post(
  "/pickups/vendor",
  controller.createVendorPickupLocation.bind(controller)
);
router.post(
  "/pickups/vendor/update",
  controller.updateVendorPickupLocation.bind(controller)
);
...
router.get(
  "/pickup-locations",
  controller.managePickupLocations.bind(controller)
);
router.post(
  "/pickup-locations",
  controller.managePickupLocations.bind(controller)
...
router.post("/invoice/download", (req, res) =>
  controller.downloadInvoice(req, res)
);
